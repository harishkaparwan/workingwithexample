...
public class FooterCreateTable {
	...
	tbl.setTblGrid(tblGrid);
			...
			for (int j = 0; j < rows; j++) {
				...
				//	System.out.println("rows+cols--"+j+i);
	               ...
	               if(j==2){
	                tc1.getEGBlockLevelElts().add( wordMLPackage.getMainDocumentPart().createParagraphOfText("Supervisor Signature:......................."));
	                tc2.getEGBlockLevelElts().add( wordMLPackage.getMainDocumentPart().createParagraphOfText("Date:...................................."));
	               }else if(j==1){
	            	   tc1.getEGBlockLevelElts().add( wordMLPackage.getMainDocumentPart().createParagraphOfText("Employee Signature:......................."));
		                tc2.getEGBlockLevelElts().add( wordMLPackage.getMainDocumentPart().createParagraphOfText("Date:...................................."));
	               }
	               else if(j==0){
	                  ...
	                  tcPr.setGridSpan(gridSpan);
	            	   tc1.getEGBlockLevelElts().add( wordMLPackage.getMainDocumentPart().createParagraphOfText("Employee Name:HARISH CHANDRA KAPARWAN"));
